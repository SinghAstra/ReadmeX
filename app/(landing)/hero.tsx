        ...
        <div className="flex flex-col items-center justify-center w-full ">
          ...
          >
            ...
            <p className="mb-4 text-lg tracking-tight text-muted-foreground md:text-xl text-balance">
              Just drop a GitHub repo link. We’ll analyze the codebase,
              summarize every file, and auto-generate your{" "}
              <code>README.md</code>, <code>CONTRIBUTING.md</code>, and{" "}
              <code>.env.example</code> to kickstart documentation.
            </p>
