...
const MagicBadge = ({ title }: Props) => {
  return (
    <div className="relative inline-flex h-8 overflow-hidden rounded-full p-[1.5px] focus:outline-none select-none">
      ...
      <span className="inline-flex h-full w-full  items-center justify-center rounded-full bg-background px-4 py-1  text-primary backdrop-blur-3xl tracking-wider font-medium text-xl">
        {title}
      </span>
    </div>
  );
